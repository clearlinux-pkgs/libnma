...
Version  : 1.8.40
Release  : 10
URL      : https://download.gnome.org/sources/libnma/1.8/libnma-1.8.40.tar.xz
Source0  : https://download.gnome.org/sources/libnma/1.8/libnma-1.8.40.tar.xz
...
%prep
%setup -q -n libnma-1.8.40
cd %{_builddir}/libnma-1.8.40
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655480702
...
cp %{_builddir}/libnma-1.8.40/COPYING %{buildroot}/usr/share/package-licenses/libnma/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libnma-1.8.40/COPYING.LGPL %{buildroot}/usr/share/package-licenses/libnma/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
%find_lang libnma

...
Source0  : https://download.gnome.org/sources/libnma/1.10/libnma-1.10.4.tar.xz
...
%prep
%setup -q -n libnma-1.10.4
cd %{_builddir}/libnma-1.10.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667867062

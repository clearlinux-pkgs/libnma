...
%prep
%setup -q -n libnma-1.8.30
cd %{_builddir}/libnma-1.8.30
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595365350
...
cp %{_builddir}/libnma-1.8.30/COPYING %{buildroot}/usr/share/package-licenses/libnma/4cc77b90af91e615a64ae04893fdffa7939db84c
cp %{_builddir}/libnma-1.8.30/COPYING.LGPL %{buildroot}/usr/share/package-licenses/libnma/01a6b4bf79aca9b556822601186afab86e8c4fbf
%make_install
%find_lang libnma
